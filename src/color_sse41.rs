...
/// Note: make sure to #[target_feature(enable = "sse4.1")] upstream somewhere
pub fn egui_blend_u8_sse41(src: [u8; 4], dst: [u8; 4]) -> [u8; 4] {
    unsafe {
        let alpha = src[3];
        if alpha == 255 {
            return src;
...
#[inline]
/// Note: make sure to #[target_feature(enable = "sse4.1")] upstream somewhere
fn unorm_mult4x4_sse41(a: [u8; 4], b: [u8; 4]) -> [u8; 4] {
    unsafe {
        let e1 = _mm_set1_epi16(0x0080);
